      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <p class="card-text">
            ...
            <a data-bs-toggle="modal" data-bs-target="#add_new_enseignant" type="button" class="btn btn-primary">Ajouter
              un enseignant</a>
          ...
          <div class="table-responsive ">
            <table class="datatable table table-stripped" id="myTable">
              ...
              <tbody>
                ...
                @endforeach
                {{-- Add Modal enseignant --}}
                <div class="modal fade" id="add_new_enseignant" aria-hidden="true" role="dialog">
                  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
