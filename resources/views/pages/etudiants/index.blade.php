                        ...
                        <table class="datatable table table-stripped" id="myTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($etudiants as $etudiant)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a data-bs-toggle="modal" href="#editetudiant_{{ $etudiant->id }}"
                                                class="btn btn-sm bg-warning-light"><i
                                    ...
                                    <!-- View Details Modal -->
                                    <div class="modal fade" id="view_etudiant_{{ $etudiant->id }}" aria-hidden="true"
                                        role="dialog">
                                                        ...
                                                        <div class="row form-row">
                                                            ...
                                                            <div class="col-12 col-md-6 col-xl-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input required type="text"
                                                                        class="form-control @error('code_massar') is-invalid @enderror"
                                                                        name="code_massar" disabled
                                                            ...
                                                            <div class="col-12 col-md-6 col-xl-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input required type="text"
                                                                        ...
                                                                        name="lieu_naissance_ar" disabled
                                                                        value="{{ $etudiant->lieu_naissance_ar }}">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="sexe" id="gender_male" disabled
                                                                                value="1"
                                                                                {{ $etudiant->sexe == 1 ? 'checked' : '' }}>
                                                                        ...
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="sexe" id="gender_female" disabled
                                                                                value="0"
                                                                                {{ $etudiant->sexe == 0 ? 'checked' : '' }}>
                                                                            <label class="form-check-label"
                                                                                for="gender_female">
                                                                                Female
                                                                            </label>
                                                            ...
                                                            <div class="row form-row">
                                                                <div class="col-12 col-md-6 col-xl-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input required placeholder="Adresse personnelle  "
                                                                            type="text" disabled
                                                                            class="form-control @error('adresse_perso1') is-invalid @enderror"
                                                                            name="adresse_perso1"
                                                                            value="{{ $etudiant->adresse_perso1 }}">
                                                                ...
                                                                <div class="col-12 col-md-6 col-xl-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input required
                                                                            placeholder="Adresse personnelle 2 "
                                                                            type="text" disabled
                                                                            class="form-control @error('adresse_perso2') is-invalid @enderror"
                                                                            name="adresse_perso2"
                                                                            value="{{ $etudiant->adresse_perso2 }}">
                                                                ...
                                                                <div class="col-12 col-md-6 col-xl-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input required
                                                                            placeholder="Adresse personnelle 3 "
                                                                            type="text" disabled
                                                                            class="form-control @error('adresse_perso3') is-invalid @enderror"
                                                                            name="adresse_perso3"
                                                                            value="{{ $etudiant->adresse_perso3 }}">
                                            ...
                                            <div class="row form-row">
                                                ...
                                                <div class="col-12 col-md-6 col-xl-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="text"
                                                            class="form-control @error('prenom_ar') is-invalid @enderror"
                                                            name="prenom_ar" value="{{ $etudiant->prenom_ar }}">
                                                        @error('prenom_ar')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="col-12 col-md-6 col-xl-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="text"
                                                            class="form-control @error('code_massar') is-invalid @enderror"
                                                            name="code_massar" value="{{ $etudiant->code_massar }}">
                                                        @error('code_massar')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="col-12 col-md-6 col-xl-2">
                                                    <div class="form-group">
                                                        <label>Province de naissance </label>
                                                        <select
                                                            class="form-control @error('province_naissance') is-invalid @enderror"
                                                            name="province_naissance">
                                                            @if ($etudiant->province_naissance != null)
                                                                <option value="{{ $etudiant->province_naissance }}"
                                                                    selected>
                                      ...
                                      @endforeach
                                                ...
                                                <div class="col-12 col-md-6 col-xl-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="sexe" id="gender_male" value="1"
                                                                    {{ $etudiant->sexe == 1 ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="sexe" id="gender_female" value="0"
                                                                    {{ $etudiant->sexe == 0 ? 'checked' : '' }}>
                                                ...
                                                <div class="col-12 col-md-6 col-xl-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input placeholder="0612345678" type="number"
                                                            class="form-control @error('telephone') is-invalid @enderror"
                                                            name="telephone" value="{{ $etudiant->telephone }}">
                                                        @error('telephone')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="col-12 col-md-6 col-xl-2">
                                                    <div class="form-group">
                                                        <label>Situation familiale</label>
                                                        <select required
                                                            class="form-control @error('situation_familiale') is-invalid @enderror"
                                                ...
                                                <div class="col-12 col-md-6 col-xl-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="fonctionnaire" id="oui" value="1"
                                                                    {{ $etudiant->fonctionnaire == 1 ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="fonctionnaire" id="no" value="0"
                                                                    {{ $etudiant->fonctionnaire == 0 ? 'checked' : '' }}>
                                                ...
                                                <div class="row form-row">
                                                    ...
                                                    <div class="col-12 col-md-6 col-xl-4">
                                                        <div class="form-group">
                                                            <label>Adresse personnelle 2</label>
                                                            <input required placeholder="Adresse personnelle 2 "
                                                                type="text"
                                                                class="form-control @error('adresse_perso2') is-invalid @enderror"
                                                                name="adresse_perso2"
                                                                value="{{ $etudiant->adresse_perso2 }}">
                                                    ...
                                                    <div class="col-12 col-md-6 col-xl-4">
                                                        <div class="form-group">
                                                            <label>Adresse personnelle 3</label>
                                                            <input required placeholder="Adresse personnelle 3 "
                                                                type="text"
                                                                class="form-control @error('adresse_perso3') is-invalid @enderror"
                                                                name="adresse_perso3"
                                                                value="{{ $etudiant->adresse_perso3 }}">
