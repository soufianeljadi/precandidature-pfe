                        ...
                        <div class="col-12 col-md-6 col-xl-2">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control @error('nom_ar') is-invalid @enderror"
                                    name="nom_ar" value="{{ auth()->user()->nom_ar }}">
                                @error('nom_ar')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <select required class="form-control @error('nom') is-invalid @enderror" name="province_naissance">
                  ...
                  @endforeach
                        ...
                        <div class="col-12 col-md-6 col-xl-2">
                            <div class="form-group">
                                <label>Ville</label>
                                <select required class="form-control @error('ville') is-invalid @enderror"
                                    name="ville">
                    ...
                    <div class="row form-row">
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input required placeholder="EX: 2023" type="text"
                                    class="form-control @error('annee_obt_bac') is-invalid @enderror"
                                    name="annee_obt_bac" value="{{ auth()->user()->dossier->annee_obt_bac }}">
                                @error('annee_obt_bac')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <select
                                    class="form-control @error('mention_bac') is-invalid @enderror"name="mention_bac">
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('province_bac') is-invalid @enderror"
                                    name="province_bac">
                                    <option disabled selected>-- Sélectionner Ville --</option>
                                    @foreach ($villes as $ville)
                                        <option value="{{ $ville->id }}">{{ $ville->nom }}</option>
                        ...
                        <div class="col-12 col-md-6 col-xl">
                            <div class="form-group">
                                ...
                                <input required type="text"
                                    class="form-control @error('academie') is-invalid @enderror" name="academie"
                    ...
                    <div class="row form-row">
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input required placeholder="EX: 2023" type="text"
                                    class="form-control @error('annee_opt_diplome') is-invalid @enderror"
                                    name="annee_obt_diplome" value="{{ auth()->user()->dossier->annee_obt_diplome }}">
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <input required type="number"
                                    class="form-control @error('moyenne_diplome') is-invalid @enderror"
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="form-group">
                                ...
                                <select
                                    class="form-control @error('mention_diplome') is-invalid @enderror"name="mention_diplome"
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <input required type="text"
                                    class="form-control @error('specialite_diplome') is-invalid @enderror"
