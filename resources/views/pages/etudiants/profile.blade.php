              ...
              <div class="form-group">
                ...
                <select class="form-control @error('province_naissance') is-invalid @enderror" name="province_naissance">
                  ...
                  @foreach ($villes as $ville)
                    <option {{ auth()->user()->province_naissance == $ville->id ? 'selected' : '' }}
            ...
            <div class="col-12 col-md-6 col-xl-2">
              <div class="form-group">
                ...
                <select required class="form-control @error('ville') is-invalid @enderror" name="ville">
                  ...
                  <option disabled selected>Changer Ville</option>
                  @foreach ($villes as $ville)
                    <option {{ auth()->user()->ville == $ville->id ? 'selected' : '' }} value="{{ $ville->id }}">
                      {{ $ville->nom }}</option>
                  @endforeach
            ...
            <div class="col-12 col-md-6 col-xl-2">
              <div class="form-group">
                ...
                <select required class="form-control @error('situation_familiale') is-invalid @enderror"
                  ...
                  <option {{ auth()->user()->situation_familiale == 'c' ? 'selected' : '' }} value="c">
                    Célibataire</option>
                  <option {{ auth()->user()->situation_familiale == 'm' ? 'selected' : '' }} value="m">Marié(e)
                  </option>
                  <option {{ auth()->user()->situation_familiale == 'd' ? 'selected' : '' }} value="d">Divorcé(e)
                  </option>
                  <option {{ auth()->user()->situation_familiale == 'v' ? 'selected' : '' }} value="v">Veuf/Veuve
                  </option>
                  <option {{ auth()->user()->situation_familiale == 'a' ? 'selected' : '' }} value="a">Autre
                  </option>
                </select>
            ...
            <div class="col-12 col-md-6 col-xl-3">
              <div class="form-group">
                ...
                <select class="form-control @error('serie_bac') is-invalid @enderror" name="serie_bac">
                  ...
                  <option {{ auth()->user()->dossier->serie_bac == 'sma' ? 'selected' : '' }} value="sma">Science
                    Math A
                  </option>
                  <option {{ auth()->user()->dossier->serie_bac == 'smb' ? 'selected' : '' }} value="smb">Science
                    Math B
                  </option>
                  <option {{ auth()->user()->dossier->serie_bac == 'pc' ? 'selected' : '' }} value="pc">Science
                    Physiques
                  </option>
                  <option {{ auth()->user()->dossier->serie_bac == 'svt' ? 'selected' : '' }} value="svt">Science vie
                    et terre
                  </option>
                  <option {{ auth()->user()->dossier->serie_bac == 'autre' ? 'selected' : '' }} value="autre">Autre
                  </option>
                </select>
                @error('serie_bac')
                  <div class="invalid-feedback">
            ...
            <div class="col-12 col-md-6 col-xl-3">
              <div class="form-group">
                ...
                <select class="form-control @error('mention_bac') is-invalid @enderror"name="mention_bac">
                  ...
                  <option {{ auth()->user()->dossier->mention_bac == '1' ? 'selected' : '' }} value="1">Très Bien
                  </option>
                  <option {{ auth()->user()->dossier->mention_bac == '2' ? 'selected' : '' }} value="2">Bien
                  </option>
                  <option {{ auth()->user()->dossier->mention_bac == '3' ? 'selected' : '' }} value="3">Assez Bien
                  </option>
                  <option {{ auth()->user()->dossier->mention_bac == '4' ? 'selected' : '' }} value="4">Passable
                  </option>
                </select>
                @error('mention_bac')
                  <div class="invalid-feedback">
            ...
            <div class="col-12 col-md-6 col-xl-3">
              <div class="form-group">
                ...
                <select class="form-control @error('province_bac') is-invalid @enderror" name="province_bac">
                  <option disabled selected>-- Sélectionner Ville --</option>
                  @foreach ($villes as $ville)
                    <option {{ auth()->user()->dossier->province_bac == $ville->id ? 'selected' : '' }}
                      value="{{ $ville->id }}">{{ $ville->nom }}</option>
                  @endforeach
                </select>
                @error('province_bac')
