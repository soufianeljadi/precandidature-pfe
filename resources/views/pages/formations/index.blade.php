                        ...
                        <table class="datatable table table-stripped">
                            ...
                            <tbody>
                                ...
                                @foreach ($formations as $formation)
                                    ...
                                    <!-- Edit Details Modal -->
                                    <div class="modal fade" id="editformation_{{ $formation->id }}" aria-hidden="true"
                                        role="dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('formation.update') }}" method="POST">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-primary btn-block w-100">Sauvegarder les
                                    ...
                                    <!-- View Details Modal -->
                                    <div class="modal fade" id="view_formation_{{ $formation->id }}" aria-hidden="true"
                                        role="dialog">
                                        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
